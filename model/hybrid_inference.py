...
def load_hybrid_model(
    ...
    if checkpoint is None:
        raise ValueError("A compatible trained checkpoint is required for inference")
    ...
    model.load_state_dict(checkpoint_data.get("state_dict", checkpoint_data), strict=True)
    model.eval()
    return model
...
def enhance(
    ...
    sample_rate: int,
    checkpoint: Union[str, Path],
    config_path: Union[str, Path] = "conf/hybrid_unise_example.yaml",
    stage: str | None = None,
